//
//  MyPagedScrollViewController.swift
//  TestScrollViewSwift
//
...
class MyPagedScrollViewController: UIViewController, UIScrollViewDelegate {

    @IBOutlet var scrollView: UIScrollView!
    @IBOutlet var pageControl: UIPageControl!

    var pageImages: [UIImage] = []      // Holds all the images to display – 1 per page.
    var pageViews: [UIImageView?] = []  // Holds instances of UIImageView to display each image.
